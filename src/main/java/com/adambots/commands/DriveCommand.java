...
public class DriveCommand extends CommandBase {
  public final TankDriveTrainSubsystem drivetrain;
   ...
   */
  public DriveCommand(TankDriveTrainSubsystem inputDriveTrain, DoubleSupplier straightInput, DoubleSupplier turnInput) {
